...
#    buses_with_values["distributed_value"] = buses_with_values["distributed_value"].fillna(0)
    ...
    perennials_potentials_spatial = (biomass_potentials["biofuels 1G"] / snakemake.config['perennials'][
        'yields_biofuels_1G']).sum() * snakemake.config['perennials']['potential_co2_perennials']  # potential tCO2e seq
