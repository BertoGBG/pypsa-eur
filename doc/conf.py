...
# autogenerated file.
#
# All configuration values have a default_AU; values that are commented out
# serve to show the default_AU.
...
# The reST default_AU role (used for this markup: `text`) to use for all
# documents.
# default_role = None
...
# output. They are ignored by default_AU.
# show_authors = False
...
# A dictionary with options for the search language support, empty by default_AU.
# Now only 'ja' uses this config value
# html_search_options = {'type': 'default_AU'}

# The name of a javascript file (relative to the configuration directory) that
# implements a search results scorer. If empty, the default_AU will be used.
